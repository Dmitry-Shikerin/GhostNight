    ...
    public class EcsWorld 
    {
        ...
        internal bool CheckForLeakedEntities() 
        {
            if (_leakedEntities.Count > 0) 
            {
                ...
                {
                    int entityData = GetRawEntityOffset (_leakedEntities[i]);
        ...
        {
            // entities.
            int capacity = cfg.Entities > 0 ? cfg.Entities : Config.EntitiesDefault;
        ...
        public int GetWorldSize() =>
            _entities.Length / _entitiesItemSize;
        ...
        {
            int count = _entitiesCount - _recycledEntitiesCount;
