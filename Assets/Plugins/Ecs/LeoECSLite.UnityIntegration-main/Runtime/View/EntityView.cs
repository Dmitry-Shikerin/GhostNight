...
namespace Mitfart.LeoECSLite.UnityIntegration.View 
{
   public sealed class EntityView : MonoBehaviour 
   {
      ...
      public void Activate() => 
         gameObject.SetActive(IsAlive = true);
      ...
      private ComponentView GetView(int i) => 
         components[i] ??= new ComponentView(this);

      private void ResizeForNewViews() =>
         Array.Resize(ref components, componentsCount);
      private bool EnoughViews() =>
